...
GitHub's [private vulnerability reporting](https://github.com/ahmeddoghri/tablextract/security/advisories/new)
...
- Request bodies are size-limited (`MAX_TEXT_CHARS`, `MAX_PDF_BYTES`) and the
  PDF endpoint rejects malformed base64 with a `400` before decoding.
